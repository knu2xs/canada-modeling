...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=canada-modeling
SET SUPPORT_LIBRARY = canada_modeling
SET ENV_NAME=canada-modeling
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/canada-modeling*.tar.bz2
